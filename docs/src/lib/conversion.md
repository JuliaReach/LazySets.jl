...
convert(::Type{Zonotope}, cp::CartesianProduct{N, <:AbstractZonotope{N}, <:AbstractZonotope{N}}) where {N}
convert(::Type{Zonotope}, cpa::CartesianProductArray{N, AbstractZonotope{N}}) where {N}
```
