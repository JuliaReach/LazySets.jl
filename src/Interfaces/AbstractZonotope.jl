...
attained at one of the ``2ⁿ`` corners.

This algorithm has time complexity `` \\mathcal{O}(2ⁿ · d), and thus only practical for zonotopes
with a small number of generators.

"""
function _l1_norm(Z::AbstractZonotope)
	n = ngens(Z)
