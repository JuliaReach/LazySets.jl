function __init__()
    ...
    @require SCS = "c946c3f1-0d1f-5ce8-9dea-7daa1f7e2d13" include("Initialization/init_SCS.jl")
    ...
    @require TaylorModels = "314ce334-5f6e-57ae-acf6-00b6e903104a" begin
        @require TaylorSeries = "6aa5eb33-94cf-58f4-a9d0-e4b2c4fc25ea" include("Initialization/init_TaylorModels.jl")
    end
