...
"""
    ρ_upper_bounds(d::AbstractVector{N}, lm::LinearMap{N}) where {N<:Real}
...
"""
function ρ_upper_bounds(d::AbstractVector{N}, lm::LinearMap{N}) where {N<:Real}
    return ρ_helper(d, lm, ρ_upper_bounds)
end
