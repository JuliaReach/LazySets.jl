...
function linear_map(M::AbstractMatrix, P::VPolygon; convex_hull::Bool=false)
...
@inline function _linear_map_vrep(M::AbstractMatrix, P::VPolygon;
    ...
    # note: `convex_hull` is ignored because the VPolygon constructor always
    # runs a convex-hull algorithm
