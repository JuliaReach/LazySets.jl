...
# hyperrectangle radius given as SingleEntryVector
# (i.e., hyperrectangle is flat in all but one direction)
@validate function ρ(d::AbstractVector, H::Hyperrectangle{N,VNC,SingleEntryVector{N}}) where {N,VNC}
    N2 = promote_type(eltype(d), N)
...
# both direction and hyperrectangle radius given as SingleEntryVector
