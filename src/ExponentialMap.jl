...
"""
    ρ_upper_bounds(d::AbstractVector{N}, em::ExponentialMap{N}) where {N<:Real}
...
able to use `expmv`.
"""
function ρ_upper_bounds(d::AbstractVector{N}, em::ExponentialMap{N}) where {N<:Real}
    return ρ_helper(d, em, ρ_upper_bounds)
end
