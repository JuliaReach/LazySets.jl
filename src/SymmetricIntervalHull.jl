...
Type that represents the symmetric interval hull of a set.
...
Return the box radius of a symmetric interval hull of a set in a given
dimension.

### Input

- `H` -- symmetric interval hull of a set
...
Return the box radius of a symmetric interval hull of a set in every dimension.
...
Return the center of a symmetric interval hull of a set.
...
Return the dimension of a symmetric interval hull of a set.
...
Return the support vector of a symmetric interval hull of a set in a given
direction.
...
Compute the radius of a symmetric interval hull of a set in a given dimension.
