...
for N in [Float32, Float64, Rational{Int}]
    ...
    @test_throws AssertionError res = overapproximate(MZ_err * P)

    #exponential map
    em = ExponentialMap(MZ, P) #test MZP
    Pex = overapproximate(em, 2)
