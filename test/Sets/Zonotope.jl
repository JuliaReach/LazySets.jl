...
for N in @tN([Float64, Float32, Rational{Int}])
    ...
    Z1, Z2, Z3, Z4 = split(Z2a, [1, 2], [1, 1])
    G = N[1//2 1//2; -1//2 1//2]
    ispermutation([Z1, Z2, Z3, Z4],
    ...
    # TODO revise
    # isdisjoint
    @test_throws DimensionMismatch isdisjoint(Z, Z2)
    # disjoint
    Z2 = Interval(N(3), N(4))
    ...
    for (pair, Z) in ((isdisjoint(Z, Z, true), Z), (isdisjoint(Z, Z2, true), Z2),
