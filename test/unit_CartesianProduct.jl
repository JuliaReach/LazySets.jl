...
p1 = HPolygon()
addconstraint!(p1, LinearConstr([2., 2.], 12.))
addconstraint!(p1, LinearConstr([-3., 3.], 6.))
addconstraint!(p1, LinearConstr([-1., -1.], 0.))
addconstraint!(p1, LinearConstr([2., -4.], 0.))
p2 = HPolygon()
addconstraint!(p2, LinearConstr([1., 0.], 1.))
addconstraint!(p2, LinearConstr([-1., 0.], 1.))
addconstraint!(p2, LinearConstr([0., 1.], 1.))
addconstraint!(p2, LinearConstr([0., -1.], 1.))
